...
assert.ok(manifest.icons.some((icon) => icon.src === '/matrixqa-favicon.png' && icon.sizes === '512x512'));
assert.ok(manifest.icons.some((icon) => icon.src === '/matrixqa-favicon-192.png' && icon.sizes === '192x192'));
assert.ok(manifest.icons.some((icon) => icon.src === '/favicon.ico'));
assert.match(rootRoute, /href: "\/matrixqa-favicon\.png"/);
assert.match(rootRoute, /href: "\/favicon\.ico"/);
assert.match(logo, /src="\/matrixqa-favicon\.png"/);
...
assert.doesNotMatch(rootRoute, /matrixqa-icon\.svg/);
assert.doesNotMatch(logo, /matrixqa-icon\.svg|matrixqa-mark|lovable/);
