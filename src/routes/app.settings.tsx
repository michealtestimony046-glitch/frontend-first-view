  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
      ...
      <div className="space-y-4">
        ...
        <section className="surface-card overflow-hidden"><header className="border-b border-border px-5 py-3"><h2 className="font-display text-sm font-semibold">About Matrix QA</h2></header><div className="space-y-2 p-5 text-xs text-muted-foreground"><Meta label="Release version" value={packageMetadata.version} /></div></section>
      </div>
    </div>
  );
}
