...
function TelemetryTab({ telemetry, health, exporting, onExport }: { telemetry: AdminTelemetrySummary | null; health: WorkerHealth | null; exporting: boolean; onExport: () => void }) {
