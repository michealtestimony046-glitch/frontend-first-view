...
function AdminPage() {
  ...
  const load = async () => {
    ...
    try {
      ...
      const [requestData, recipientData, telemetryData, matrixUnitData, aiProviderData, healthData, managedSecretData, staffManagementData, controlTowerData, metricsData, reliabilityData, customerData, alphaParticipantData, complaintData, suspensionData, workforceAgentData] = await Promise.all([
