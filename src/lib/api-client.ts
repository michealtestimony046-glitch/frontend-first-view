...
// Versioned key deliberately invalidates any token left by the old mock/auth builds.
...
export const organizationsApi = {
  list: (): Promise<Organization[]> =>
    apiRequest('/organizations', { requiresAuth: true }),
...
export const projectsApi = {
  list: (organizationId: string): Promise<Project[]> =>
    apiRequest(`/projects?organizationId=${encodeURIComponent(organizationId)}`, {
      requiresAuth: true,
    }),
